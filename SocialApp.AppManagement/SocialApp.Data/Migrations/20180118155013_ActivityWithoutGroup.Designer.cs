...
namespace SocialApp.Data.Migrations
{
	...
	[Migration("20180118155013_ActivityWithoutGroup")]
	partial class ActivityWithoutGroup
	{
...
#pragma warning disable 612, 618
			...
			modelBuilder.Entity("GoingOut.Core.Data.GroupRoles", b =>
				{
			...
			modelBuilder.Entity("GoingOut.Core.Data.PlanRoles", b =>
				{
					b.Property<int>("RoleId")
						.ValueGeneratedOnAdd();
			...
			modelBuilder.Entity("GoingOut.Core.Data.GroupUser", b =>
				{
					...
					b.HasOne("GoingOut.Core.Data.GroupRoles", "Role")
						.WithMany("GroupUsers")
			...
			modelBuilder.Entity("GoingOut.Core.Data.UserPlan", b =>
				{
					...
					b.HasOne("GoingOut.Core.Data.PlanRoles", "Role")
						.WithMany("UserPlans")
						.HasForeignKey("RoleId")
						.OnDelete(DeleteBehavior.Cascade);
